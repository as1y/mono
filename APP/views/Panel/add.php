        ...
        <form action="#">
            ...
            <fieldset class="mb-3">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-10">
                        <div class="uniform-uploader"><input type="file" class="form-control-uniform" data-fouc=""><span class="filename" style="user-select: none;">No file selected</span><span class="action btn btn-light" style="user-select: none;">Choose File</span></div>
                    </div>
                </div>
            ...
            <fieldset class="mb-3">
                ...
                <div class="form-group row">
                    <label class="col-form-label col-lg-2">Styled select</label>
                    <div class="col-lg-10">
                        <div class="uniform-select bg-pink-400 border-pink-400 fixedWidth"><span style="user-select: none;">Custom styled select color</span><select class="form-control form-control-uniform-custom">
