<div class="card">
    <div class="card-header bg-dark text-white header-elements-inline">
        <h5 class="card-title">ГЕНЕРАТОР ОБЪЯВЛЕНИЙ ЯНДЕКС</h5>
    ...
    <div class="card-body">
        ...
        <div class="col-md-6">
            <form action="/panel/generateadvertya/?action=generateall" method="post" data-fouc>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <form action="/panel/generateadvertya/?action=generate" method="post" data-fouc>
        ...
        <form action="/panel/generateadvertya/?action=export" method="post" data-fouc>


            <div class="row">
                <div class="col-md-12">
                    <h2>КАМПАНИЯ</h2>
                    <input type="text"  name="namecompany" class="form-control"  value="ПОИСК WORK">
