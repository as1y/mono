        ...
        <div class="card border-dark">
            ...
            <div class="card-body">
                ...
                <table class="table  table-bordered text-center">
                    <tr>
                        <td class="wmin-md-100"> <button type="button" class="btn bg-teal-400 btn-labeled"><b><i class="icon-reading"></i></b> ПОЗВОНИТЬ</button></td>

                        <td class="wmin-md-100"> <button type="button" class="btn bg-slate-600 btn-labeled">СЛЕДУЮЩИЙ КОНТАКТ <b><i class="icon-reading"></i></b></button></td>
