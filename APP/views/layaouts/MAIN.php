                    ...
                    <div class="col pl-0 d-none d-xl-block">
                        <form class="js-focus-state">
                            ...
                            <div class="input-group">
                                <input type="email" class="form-control py-2 pl-5 font-size-15 border-right-0 height-40 border-width-2 rounded-left-pill border-primary" name="email" id="searchproduct-item" placeholder="Например, Беру ..." aria-label="Search for products" aria-describedby="searchProduct1" required>
                                ...
                                <div id="navBar" class="collapse navbar-collapse u-header__navbar-collapse">
                                    <ul class="navbar-nav u-header__navbar-nav">
                                        ...
                                        <li class="nav-item u-header__nav-item">
                                            <a class="nav-link u-header__nav-link text-sale" href="/" aria-haspopup="true" aria-expanded="false" aria-labelledby="pagesSubMenu">Главная</a>
                                        </li>
                                        <!-- End Featured Brands -->
                                        ...
                                        <!-- Featured Brands -->
                                        <li class="nav-item u-header__nav-item">
                                            <a class="nav-link u-header__nav-link" href="#" aria-haspopup="true" aria-expanded="false" aria-labelledby="pagesSubMenu">Все магазины</a>
                                        </li>
                                        <!-- End Featured Brands -->
                                ...
                                <li class="col d-xl-none px-2 px-sm-3 position-static">
                                    ...
                                    <div id="searchClassic" class="dropdown-menu dropdown-unfold dropdown-menu-right left-0 mx-2" aria-labelledby="searchClassicInvoker">
                                        <form class="js-focus-state input-group px-3">
                                            <input class="form-control" type="search" placeholder="Например, Беру ...">
                                            <div class="input-group-append">
