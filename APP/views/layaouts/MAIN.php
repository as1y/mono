                ...
                <div class="row align-items-center">
                    ...
                    <div class="space50 d-none d-md-block d-lg-none"></div>
                        ...
                        <div class="d-flex flex-row justify-content-center">
                            ...
                            <div>
                                <h5>Оператор совершает звонки</h5>
                        ...
                        <div class="d-flex flex-row justify-content-center">
                            ...
                            <div>
                                ...
                                <p class="mb-0">Оператор совершил успешный звонок. Например заинтереосвал клиента в продукте.</p>
                            </div>
                        </div>
                        ...
                        <div class="d-flex flex-row justify-content-center">
                            ...
                            <div>
                                <h5>Проверка успешного звонка рекламодателем</h5>
                                <p class="mb-0">Рекламодатель присваивает статус (отклонен, подтвержден, доработка). В случае если статус подтвержден оператору поступает оплата за успешную заявку
                                </p>
                            </div>
                        </div>
