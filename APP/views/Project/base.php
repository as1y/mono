        ...
        <div class="table-responsive">
            <table class="table  table-bordered">
                ...
                <tr>
                    ...
                    <td class="wmin-md-350"><?=$contact['otkaz']?> <button class='btn btn-success' onclick="switchotkaz('<?=$idc?>')" > <i class='icon-database-refresh'></i> ПОВТОРНО <i class='fa fa-refresh'></i></button></td>

                </tr>

                <tr>
                    <td class="wmin-md-100">ТЕЛЕФОН НЕ ДОСТУПЕН:</td>
                    <td class="wmin-md-350"><?=$contact['bezdostupa']?> <button class='btn btn-success' onclick="switcnedostup('<?=$idc?>')" > <i class='icon-database-refresh'></i> ПОВТОРНО <i class='fa fa-refresh'></i></button></td>
                </tr>
                <tr>
